...
class SSCLazyIndexedStack extends StatefulWidget {
  const SSCLazyIndexedStack({
    Key? key,
  ...
  @override
  SSCLazyIndexedStackState createState() => SSCLazyIndexedStackState();
}

class SSCLazyIndexedStackState extends State<SSCLazyIndexedStack> {
  ...
  @override
  void didUpdateWidget(covariant SSCLazyIndexedStack oldWidget) {
